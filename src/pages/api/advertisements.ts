...
async function GET(req: NextApiRequest, res: NextApiResponse) {
  console.log('GET /api/advertisements (App Router)');
...
async function POST(req: NextApiRequest, res: NextApiResponse) {
  console.log('POST /api/advertisements (App Router)');
  ...
  try {
    ...
    return res.status(500).json({ error: 'Advertisements POST: ' + error.message });
  }
}
