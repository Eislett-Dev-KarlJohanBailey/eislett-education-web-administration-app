...
import { handleFetchFeatureFlagById, handleUpdateFeatureFlag, UpdateFeatureFlagRequest } from "@/services/featureFlags/featureFlagsRequest";
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2 border p-4 rounded-lg">
                <div className="grid grid-cols-4 gap-2">
                  <select
                    value={newRule.type}
                    onChange={(e) => setNewRule({ ...newRule, type: e.target.value as FeatureFlagRule["type"] })}
